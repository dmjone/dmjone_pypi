...
class Apple:
    def __init__(self, parent_screen):
        ...
        self.image = pygame.image.load("recources/apple.jpg").convert()
        self.x = 120
        self.y = 120
...
class Snake:
    def __init__(self, parent_screen):
        self.parent_screen = parent_screen
        self.image = pygame.image.load("recources/block.jpg").convert()
        self.direction = 'down'
...
class Game:
    ...
    def render_background(self):
        bg = pygame.image.load("recources/background.jpg").convert()
